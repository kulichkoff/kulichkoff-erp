...
Run `ng serve my-app` for a dev server. Navigate to http://localhost:4200/. The app will
...
Run `ng build my-app` to build the project. The build artifacts will be stored in the `dist/`
